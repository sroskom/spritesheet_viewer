...
class SpriteCarousel(Carousel):
    def __init__(self, *args):
        ...
        spriteList = SpriteAtlas.getSpriteListFromAtlas('Old hero.png',16)
        for i in spriteList:
            self.add_widget(i)
...
class SpriteAnimator(Widget):
    def __init__(self, *args):
        ...
        self.spriteList = SpriteAtlas.getSpriteListFromAtlas('Items.png',16)
    ...
    def on_touch_down(self, touch, *args):
        super(SpriteAnimator,self).on_touch_down(touch)
